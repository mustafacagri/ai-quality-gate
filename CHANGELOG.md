...
* **path:** improve relative path resolution with workspace fallback ([ebaeafb](https://github.com/mustafacagri/ai-quality-gate/commit/ebaeafb4984b1f4daf13c798c2930822c2f3d7ca))
